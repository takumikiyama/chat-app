...
export default function FixedTabBar() {
    ...
    return (
        <div className="fixed bottom-8 left-1/2 scale-[1.6] transform -translate-x-1/2 bg-white/60 rounded-full shadow-2xl flex justify-center items-center gap-8 px-5 py-2">
